...
class Config:
    grid_size: int = 64
    inducing_grid_sizes: tuple[int, ...] = (8, 16, 32)
    ...
    jitter: float = 5e-4
    output_root: str = "outputs/grid64"
    run_name: str = "grid64_thesis_comparison"
...
def parse_args(default_grid_size: int | None = None) -> Config:
    ...
    parser.add_argument("--output-root", default="outputs/grid64")
